import { TesoreriaList, TransaccionPago, CompGastoList, TotalesList, ConceptosDetalle, EditaMontoDetalle, ConfigPago, TipoTransaccion} from './tesoreria';
...
export const tesoreriaLists: TesoreriaList[] = [
    {
        ...
        FechaAprobacion:new Date('06/02/2020'),  
        ...
        AP_ID:0,  
        RP_ID:1, 
        FechaRegistroPago:new Date('06/02/2020'),
    },
    {
        id:2,
        IdColaborador:1, 
        ...
        BancoReceptor:'Bancomer',   
        CuentaReceptor:'5124101895',   
        FechaAprobacion:new Date('07/02/2020'),  
        TipoTransaccion:'Anticipo',  
        ...
        AP_ID:1,  
        RP_ID:0, 
        FechaRegistroPago:new Date('07/02/2020'),
    },
    {
        id:3,
        IdColaborador:1, 
        ...
        BancoReceptor:'Bancomer',   
        CuentaReceptor:'5124101895',   
        FechaAprobacion:new Date('08/10/2020'),  
        TipoTransaccion:'Reembolso',  
        ...
        AP_ID:0,  
        RP_ID:2, 
        FechaRegistroPago:new Date('08/11/2020'),
    },
];
...
export const tipotransaccion: TipoTransaccion[] = [
    {
        idTipoTransaccion:3,
        transaccion:'TODOS'  
    },
