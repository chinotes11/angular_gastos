...
import { TesoreriaList,DatosFiscales, DatosFinancieros,DatosUsuario ,Facturas,Causa, TransaccionPago, CompGastoList, TotalesList, ConceptosDetalle, EditaMontoDetalle} from './tesoreria';
import { tesoreriaLists, datosFiscales, datosFinancieros ,datosUsuario,facturas,tesoreriaDetalles, compgastoLists, totalesLists, conceptosDetalles, editamontoDetalles} from './tesoreria-data';
...
export class ServiceinvoiceService {
    ...
    constructor(private http: HttpClient,private tokenService: TokenService) {
        ...
        this.getFacturas().subscribe((data) => this.facturasList.push(data)  );
    ...
    public getFactuasOrden() {
        return this.facturasList;
    }
