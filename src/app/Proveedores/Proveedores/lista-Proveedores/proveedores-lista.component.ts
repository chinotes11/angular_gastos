...
/** Clase para Listar. */
export class ListaProveedoresPComponent implements OnInit, OnDestroy {
  ...
  arrSelecto:any;
  layout: string= '0';
  displayedColumns:string[]=['select','NombreComercial','RazonSocial','RFCTAXID','TipoProveedor','Estatus','FechaRegistro', 'Enviar'];
