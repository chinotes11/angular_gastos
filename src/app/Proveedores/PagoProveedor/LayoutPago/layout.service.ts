...
import { TesoreriaList, Causa, TransaccionPago, CompGastoList, TotalesList, ConceptosDetalle, EditaMontoDetalle} from './layout';
import { tesoreriaLists, tesoreriaDetalles, compgastoLists, totalesLists, conceptosDetalles, editamontoDetalles} from './layout.data';
